...
//  SOS Ciclista
//
//  Created by John A. Cristobal on 8/9/19.
...
class OnboardingPagerViewController: UIPageViewController {
    ...
    weak var tutorialDelegate: OnboardingPagerViewControllerDelegate?
    
    fileprivate(set) lazy var orderedViewControllers: [UIViewController] = {
        return [self.newColoredViewController(color: "primero"),
                self.newColoredViewController(color: "segundo"),
                self.newColoredViewController(color: "tercero"),
                self.newColoredViewController(color: "cuarto"),
                self.newColoredViewController(color: "quinto"),
        self.newColoredViewController(color: "sexto")]
...
protocol OnboardingPagerViewControllerDelegate: class {
     ...
     */
    func onboardingViewController(tutorialPageViewController: OnboardingPagerViewController,
